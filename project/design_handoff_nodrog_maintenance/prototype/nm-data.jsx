// nm-data.jsx — Nodrog Logistics Maintenance: themes + seed data
// Stands in for a real database (Supabase/Firebase tables). Exposed on window.
...
Object.assign(window, {
  THEMES, ACCENT2_OPTIONS, FLEETS, SEED_USERS, SEED_TRUCKS, SEED_ISSUES,
  SEED_PARTS, SEED_USAGE, SEED_HISTORY, SEED_INSPECTIONS, SEED_INVOICES,
  INSPECT_POSITIONS, INSPECT_POSITION_CATS, INSPECT_SINGLE, INSPECT_FLUIDS, INSPECT_DRIVETRAIN,
});
